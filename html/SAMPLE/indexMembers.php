      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse">
		  ...
		  <ul class="nav navbar-nav">
			<li><a href="register.php">Manage Contest</a></li>
      ...
      <div class="jumbotron">
        ...
        <div class="row">
          <div class="col-lg-12">
              ...
              <h1 id="tables">Current/Previous Contests</h1>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>Elect Alice</td>
                    <td>11/04/13 - 11/12/13</td>
                    <td><a href="#">Scoreboard</a></td>
                  </tr>
                  <tr>
                    <td>2</td>
                    <td>Poetry in Motion</td>
                    <td>04/15/13 - 04/22/13</td>
                    <td><a href="#">Scoreboard</a></td>
                  </tr>
                  <tr>
                    <td>3</td>
                    <td>Not so Scary Stuff :)</td>
                    <td>11/12/12 - 11/20/12</td>
                    <td><a href="#">Scoreboard</a></td>
                  </tr>
                  <tr>
                    <td>4</td>
                    <td>Scary Stuff</td>
                    <td>10/31/12 - 11/20/12</td>
                    <td><a href="#">Scoreboard</a></td>
                  </tr>
				  <tr>
                    <td>5</td>
                    <td>April Showers</td>
                    <td>04/04/12 - 04/13/12</td>
                    <td><a href="#">Scoreboard</a></td>
                  </tr>
